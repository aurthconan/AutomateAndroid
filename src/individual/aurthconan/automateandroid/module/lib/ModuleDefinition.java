...
public class ModuleDefinition implements Parcelable {
    ...
    static private Vector<TYPE> readVectorOfTypeFromParcel( Parcel in ) {
        ...
        int max = in.readInt();
        Log.i("ReadVectorOfType", "size " + max);
        for ( int i = 0; i < max; ++i ) {
    ...
    static public class MethodDefinition implements Parcelable {
        ...
        public MethodDefinition( Parcel in ) {
            ...
            Log.i("MethodDefinition", "ReturnType " + mReturnType.toString());
            mName = in.readString();
            Log.i("MethodDefinition", "name " + mName);
    ...
    public ModuleDefinition( Parcel in ) {
        mName = in.readString();
        Log.i("ModuleDefinition", "Module name " + mName);
        int max = in.readInt();
        Log.i("ModuleDefinition", "method count " + max);
        for ( int i = 0; i < max; ++i ) {
